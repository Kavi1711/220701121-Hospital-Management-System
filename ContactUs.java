...
public class ContactUs {
    ...
    ContactUs() {
        ...
        contactus.addActionListener(ae -> {
            contactusframe.setVisible(false);
            new ContactUs();
        });
        ...
        ImageIcon icon_map = new ImageIcon("C:\\hms\\Hospital-Management-System-master (4)\\Hospital-Management-System-master\\Images\\map.jpg");
        ...
        submit.addActionListener(ae -> {
            try {
                ...
                pst.executeUpdate();
                JOptionPane.showMessageDialog(null, "Your Comments are received");
                email.setText("");
    ...
    public static void main(String a[]) {
        SwingUtilities.invokeLater(ContactUs::new);
    }
}
